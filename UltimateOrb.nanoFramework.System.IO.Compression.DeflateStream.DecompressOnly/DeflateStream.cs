...
using static System.IO.StreamExtensions;
...
namespace System.IO.Compression {
    ...
    public partial class DeflateStream : Stream {
        ...
        internal DeflateStream(Stream stream, CompressionMode mode, long uncompressedSize) : this(stream, mode, leaveOpen: false, Deflate_DefaultWindowBits, uncompressedSize) {
        }

        public DeflateStream(Stream stream, CompressionMode mode) : this(stream, mode, leaveOpen: false) {
        }

        public DeflateStream(Stream stream, CompressionMode mode, bool leaveOpen) : this(stream, mode, leaveOpen, Deflate_DefaultWindowBits) {
        }
        ...
        // Implies mode = Compress
        public DeflateStream(Stream stream, CompressionLevel compressionLevel, bool leaveOpen) : this(stream, compressionLevel, leaveOpen, Deflate_DefaultWindowBits) {
        }
#endif
        ...
        public DeflateStream(Stream stream, ZLibCompressionOptions compressionOptions, bool leaveOpen = false) : this(stream, compressionOptions, leaveOpen, Deflate_DefaultWindowBits) {
        }
        */
        ...
        internal DeflateStream(Stream stream, ZLibCompressionOptions compressionOptions, bool leaveOpen, int windowBits) {
            ...
            InitializeDeflater(stream, (CompressionLevel)compressionOptions.CompressionLevel, (CompressionStrategy)compressionOptions.CompressionStrategy, leaveOpen, windowBits);
        }
#endif
        ...
        internal DeflateStream(Stream stream, CompressionMode mode, bool leaveOpen, int windowBits, long uncompressedSize = -1) {
            ArgumentNullException_ThrowIfNull(stream);

            switch (mode) {
            case CompressionMode.Decompress:
                if (!stream.CanRead)
                    throw new ArgumentException(/*SR.NotSupported_*/"UnreadableStream", nameof(stream));
...
#if FEATURE_COMPRESSION
                InitializeDeflater(stream, CompressionLevel.DefaultCompression, CompressionStrategy.DefaultStrategy, leaveOpen, windowBits);
                break;
#else
            ...
            default:
                throw new ArgumentException(/*SR.ArgumentOutOfRange_*/"Enum", nameof(mode));
            }
        }
        ...
        internal void InitializeDeflater(Stream stream, CompressionLevel compressionLevel, CompressionStrategy strategy, bool leaveOpen, int windowBits) {
        ...
        private static CompressionLevel GetZLibNativeCompressionLevel(CompressionLevel compressionLevel) =>
            compressionLevel switch {
                CompressionLevel.Optimal => CompressionLevel.DefaultCompression,
                CompressionLevel.Fastest => CompressionLevel.BestSpeed,
                CompressionLevel.NoCompression => CompressionLevel.NoCompression,
                CompressionLevel.SmallestSize => CompressionLevel.BestCompression,
                _ => throw new ArgumentOutOfRangeException(nameof(compressionLevel)),
            };

        private static int GetMemLevel(CompressionLevel level) =>
        ...
        */
        ...
        private void EnsureNotDisposed() {
            ObjectDisposedException_ThrowIf(_stream is null, this);
        }
        ...
        private static void ThrowGenericInvalidData() =>
            ...
            throw new /*InvalidDataException*/SystemException(/*SR.*/"GenericInvalidData");

        private static void ThrowTruncatedInvalidData() =>
            throw new /*InvalidDataException*/SystemException(/*SR.*/"TruncatedData");
        /*
        ...
        */
        ...
        private void PurgeBuffers(bool disposing) {
            ...
            if (_wroteBytes) {
                ...
                // the object get disposed because eventually ReleaseHandle will get called during
        ...
        private sealed class CopyToStream : Stream {
            ...
            */
            ...
            public CopyToStream(DeflateStream deflateStream, Stream destination, int bufferSize/*, CancellationToken cancellationToken*/) {
                ...
                _arrayPoolBuffer = new byte[bufferSize];
            }
